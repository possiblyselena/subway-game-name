...
var LiveMap = class _LiveMap extends LiveObject {
  ...
  *values() {
  ...
  _mergeInitialDataFromCreateOperation(objectOperation, msg) {
    ...
    const aggregatedUpdate = { update: {}, clientId: msg.clientId, connectionId: msg.connectionId };
  ...
  _applyMapSet(op, opSerial, msg) {
    ...
    const update = { update: {}, clientId: msg.clientId, connectionId: msg.connectionId };
